...
const CMS = (props) => {
    ...
    return (<div className="row">
                ...
                <ul className="list-unstyled">
                    ...
                    <li>
                        ...
                        <div className="input-group mb-3">
                            ...
                            <button className="btn btn-outline-info" type="button" onClick={() => updateSearchWords("add", null)}>Add Search Term</button>
                        </div>
                    ...
                    <li>
                        ...
                        <div className="input-group mb-3">
                            ...
                            <button className="btn btn-outline-info" type="button" onClick={() => updateImgList("add", null)}>Add Image</button>
                        </div>
        ...
        {selectionObj ? <Inventory selectionObj={selectionObj} userEmail={props.userEmail} showAlert={props.showAlert} config={props.config} GrabAllItems={props.GrabAllItems} switchFunc={switchFunc} /> : null}
    </div>)
